...
export const cascadePlanToStaff = async (branchPlan) => {
  try {
    ...
    // Separate MSOs from other positions (use enum keys - no @map on these)
    const msoPositions = ['Member_Service_Officer_I', 'Member_Service_Officer_II', 'Member_Service_Officer_III'];
